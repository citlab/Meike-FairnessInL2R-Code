...
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold1_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/

cd $PATH_TO_EXECUTABLE_DELTR 
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold1_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold1_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold1_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/

FOLD=fold_2

echo "$FOLD predictions..."
cd $PATH_TO_EXECUTABLE_LISTNET
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold2_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/

cd $PATH_TO_EXECUTABLE_DELTR 
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold2_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold2_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold2_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/

FOLD=fold_3

echo "$FOLD predictions..."
cd $PATH_TO_EXECUTABLE_LISTNET
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold3_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/

cd $PATH_TO_EXECUTABLE_DELTR 
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold3_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold3_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold3_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/
...
echo "$FOLD predictions..."
cd $PATH_TO_EXECUTABLE_LISTNET
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold4_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/

cd $PATH_TO_EXECUTABLE_DELTR 
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold4_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold4_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold4_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/
...
echo "$FOLD predictions..."
cd $PATH_TO_EXECUTABLE_LISTNET
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold5_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/COLORBLIND/

cd $PATH_TO_EXECUTABLE_DELTR 
./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold5_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=0/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold5_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=SMALL/

./predict.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/chileDataL2R_gender_nosemi_fold5_test.txt $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/model.m $PATH_TO_BIG_TREC_DATASETS/$FOLD/GAMMA\=LARGE/
