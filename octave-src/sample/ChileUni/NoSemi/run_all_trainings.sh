...
./train.m $PATH_TO_CHILE_NOSEMI_DATASETS/$EXPERIMENT/$FOLD/PREPROCESSED/ $PATH_TO_CHILE_NOSEMI_DATASETS/$EXPERIMENT/$FOLD/chileDataL2R_gender_nosemi_fold1_train_RERANKED_PPlus.txt $PATH_TO_CHILE_NOSEMI_DATASETS/$EXPERIMENT/$FOLD/PREPROCESSED_PPlus/model.m
