...
#./predict.m $PATH_TO_LSAT_DATASETS/$FOLD/LawStudents_Race_test.txt $PATH_TO_LSAT_DATASETS/$FOLD/PREPROCESSED_PPlus/model.m $PATH_TO_LSAT_DATASETS/$FOLD/PREPROCESSED_PPlus/

#./predict.m $PATH_TO_LSAT_DATASETS/$FOLD/LawStudents_Race_test.txt $PATH_TO_LSAT_DATASETS/$FOLD/PREPROCESSED_PMinus/model.m $PATH_TO_LSAT_DATASETS/$FOLD/PREPROCESSED_PMinus/
