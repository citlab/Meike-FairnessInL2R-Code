...
def listnet_gradient(GAMMA, training_features, training_judgments, predictions, query_ids, prot_idx):
    ...
    u2 = lambda which_query: normalized_topp_prot_deriv_per_group(data_per_query(which_query, training_features)[2],
    ...
    u3 = lambda which_query: normalized_topp_prot_deriv_per_group(data_per_query(which_query, training_features)[1],
                                                       data_per_query(which_query, training_features)[0],
    ...
    l1 = lambda which_query: np.dot(data_per_query(which_query, training_features)[0], topp(data_per_query(which_query, training_judgments)[0]))
