...
def prepare():
    data = pd.read_csv('../experiments/TREC/features_withListNetFormat_withGender_withZscore_candidateAmount-200_total.csv',
                       sep=',',
    ...
    train_fold5.to_csv('../experiments/TREC/fold_5/features_withListNetFormat_withGender_withZscore_candidateAmount-200_train.csv', index=False, header=False)
    test_fold5.to_csv('../experiments/TREC/fold_5/features_withListNetFormat_withGender_withZscore_candidateAmount-200_test.csv', index=False, header=False)
